...
export function FeaturedStationsGrid({ stations }: FeaturedStationsGridProps) {
  ...
  return (
    <div className="mb-12 rounded-2xl bg-featured-grid-gradient p-6 border border-white/5 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
